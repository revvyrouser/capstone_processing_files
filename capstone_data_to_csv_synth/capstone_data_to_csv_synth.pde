...
dataTable.addColumn("t_mil");
dataTable.addColumn("acc_x");
dataTable.addColumn("acc_y");
dataTable.addColumn("acc_z");

dataTable.addColumn("gyro_x");
dataTable.addColumn("gyro_y");
dataTable.addColumn("gyro_z");

dataTable.addColumn("mag_x");
dataTable.addColumn("mag_y");
dataTable.addColumn("mag_z");
...
newRow.setFloat("t_mil",sensorVals[0]);
newRow.setFloat("acc_x", sensorVals[1]);
newRow.setFloat("acc_y", sensorVals[2]);
newRow.setFloat("acc_z", sensorVals[3]);
newRow.setFloat("gyro_x", sensorVals[4]);
newRow.setFloat("gyro_y", sensorVals[5]);
newRow.setFloat("gyro_z", sensorVals[6]);
newRow.setFloat("mag_x", sensorVals[7]);
newRow.setFloat("mag_y", sensorVals[8]);
newRow.setFloat("mag_z", sensorVals[9]);
